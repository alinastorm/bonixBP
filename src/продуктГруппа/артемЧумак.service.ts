...
export class ArtemChumak extends ProductService {
    ...
    /** обработать Excel Закупки Продажи Менеджеров
     * Я создаю на основе расчетной таблички
     * Опорный файл для заказа поставщикам 
     * Вносятся продажи за период резервы, свободный остаток
     */
    ...
    /** провести Ежегодные Переговоры С Поставщиками
     * в конце финансового года договариваемся на следующий год
     * С поставщиком есть ежегодные договоренности вывоза ежемесячного вывоза автомобилей. Я могу двигать план между месяцами. Если что то не добрал могу в следующем месяце добрать
     */
    провестиЕжегодныеПереговорыСПоставщиками() { }
    /** проведение переговоров о скидке с поставщиком
     * запрашиваются под тендер и 
     * скидку у поставщика
     * Необходимы объяснить
     * скидка от 0 до 35%
     */
    проведениеПереговоровОСкидкеСПоставщиком() { }
}